...
export function MobileNav({ readyUnseenEvents }: { readyUnseenEvents: number }) {
  ...
  return (
    <>
      {drawerOpen && (
        <div className="fixed inset-0 z-40 flex flex-col justify-end bg-background-deep/80 lg:hidden" onClick={() => setDrawerOpen(false)}>
          <div
            className="pb-sheet-safe panel panel-bracketed flex max-h-[80dvh] flex-col overflow-y-auto"
